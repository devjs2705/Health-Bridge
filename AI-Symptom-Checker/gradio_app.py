...
def process_inputs(audio_filepath, image_filepath):
    speech_to_text_output = translate_transcribe_groq(GROQ_API_KEY=os.environ.get("GROQ_API_KEY"), 
    ...
    voice_of_doctor = text_to_speech_with_gtts(input_text=doctor_response, output_filepath="final.mp3",language=lang)

    #translate the patient and doctor response to given language
    ...
    return translated_text_patient, doctor_response_translated, voice_of_doctor
